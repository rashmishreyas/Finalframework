...
public class ChangePage {
    ...
    public static WebElement getCancelTaskButton(WebDriver driver)
    {
    	element=driver.findElement(By.id("cancel_task"));
    	return element;
    }
  ...
  public static WebElement getCompleteAssessmentBtn(WebDriver driver)
  {
	  element=driver.findElement(By.xpath("//button[text()='Complete Assessment']"));
	  return element;
  }
  
  public static WebElement getRequestImplementationApproval(WebDriver driver)
  {
	  element=driver.findElement(By.xpath("//button[text()='Request Implementation Approval']"));
	  return element;
  }
  ...
  public static WebElement getImplementationSubcode(WebDriver driver)
  {
	  element=driver.findElement(By.id("change_task.u_closure_subcode"));
	  return element;
  }
