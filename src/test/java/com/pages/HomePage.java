...
public class HomePage {
    ...
    public static WebElement getCreateNewBtn1(WebDriver driver){
    	...
    	WebElement element = driver.findElement(By.xpath("//a[@class='sn-widget-list-item sn-widget-list-item_hidden-action module-node state-active']"));
    ...
    public static WebElement getAllLnk(WebDriver driver){
      ...
      element = driver.findElement(By.xpath("//div[@class='sn-widget-list-content']"));
    	return element;
     }
