    ...
    private void createTestSummaryHTMLTable() throws IOException
    {
        ...
        //  htmlStringBuilder.append("<b>Environment used:</b> "+ BaseTest.Envirnomentundertest + "<br />");
         // htmlStringBuilder.append("<b>Browserd used:</b> "+ BaseTest.BrowserType + "<br />");
     	 ...
     	 String jenkinsTestReportUrl = "http://fenric.pe.int.thomsonreuters.com/job/SNOW_QA/test-output";
         
         htmlStringBuilder.append("<p>Access complete regression report"+ "<a href='" + "http://fenric.pe.int.thomsonreuters.com/job/SNOW_QA/test-output" + "' target='_blank'> here </a></p>");
